...
fitCL <- polr(factor(L_03) ~ FG_01+G_02+D_11_P+G_11+D_09+CEDAD+SEXO, data = MD_Lc, Hess = TRUE, method = "probit")
scope <- list(lower=~FG_01+G_02+D_11_P+G_11+D_09+CEDAD, 
              upper=~ L_08_VALOR+ L_09_A+ L_09_B+ L_09_C+ L_09_D+ L_09_E+ L_09_F+ L_09_G+ L_09_H+ L_09_I+ L_10_A+ L_10_B+ L_11_A+L_11_B+L_11_C+L_11_D+L_11_E+L_11_F+L_11_G+L_11_H+L_11_I+L_11_J+L_11_K+L_11_L+L_11_M+L_11_N+L_11_O+
                FG_01 + G_02 + D_11_P + G_11 + D_09 + CEDAD + SEXO +
                D_01 + D_02 + D_06 + D_07 + D_08 + D_10 + +D_12_A + D_12_B + D_12_C + D2_01 + D2_03 + D2_05 + D2_06 + 
                TIPO + ESTRATO + PARENTESCO + F_12 + Q_02 + Q_03 + D_05 + TOTAL_PERSONAS)
...
fit5L_mass <- polr(factor(L_03) ~ FG_01 + G_02 + D_11_P + G_11 + 
                     D_09 + CEDAD + SEXO + L_11_H + L_11_O+ L_09_C + 
                     F_12 + D_06 + Q_02 + L_11_A + L_11_K + L_09_E +
                     L_09_A + L_11_G, data = MD_Lc, Hess = TRUE, method = "probit")

fit5L_ord <- clm(factor(L_03) ~ FG_01 + G_02 + D_11_P + G_11 + 
                   D_09 + CEDAD + SEXO + L_11_H + L_11_O+ L_09_C + 
                   F_12 + D_06 + Q_02 + L_11_A + L_11_K + L_09_E +
                   L_09_A + L_11_G, data = MD_Lc, link = "probit")
...
#### fitC ----
fitCL_mass <- polr(factor(L_03) ~ FG_01+G_02+D_11_P+G_11+D_09+CEDAD+SEXO, data = MD_Lc, Hess = TRUE, method = "probit")
fitCL_ord  <- clm(factor(L_03) ~ FG_01+G_02+D_11_P+G_11+D_09+CEDAD+SEXO, data = MD_Lc, link = "probit")
