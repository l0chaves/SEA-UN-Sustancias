...
pyramid(datos,Llab="Masculino",Rlab="Femenino",Clab="Edad",main="Survey age_sex distribution",Cstep=2,Rcol="#836FFF",Lcol="#FF6347")
#Graficos marginales
...
ggplot(d, aes(x = D_01)) + geom_bar(fill = c("red","blue")) +
