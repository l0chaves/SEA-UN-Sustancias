source("C:/Users/jufem/OneDrive/Documentos/Semillero SEA/SEMILLERO-SEA-UNAL_Juan/Drogas/DATOS_v2.R")
############################################################################################################################
####################################################################################
# ACM / cluster ----
library(FactoMineR)
...
Datos<-subset(Datos,select=c("SEXO","PARENTESCO","grupo_edad","D_01","D_02","D_07","D2_01","D2_05"))
library(FactoMineR)
library(factoextra)
